...
"""Предельное число заказчиков в списке.

Ограничение введено ради времени отрисовки страницы. При дальнейшем росте
числа заказчиков потребуется постраничная навигация.
"""
