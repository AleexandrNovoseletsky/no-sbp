...
Проверки выполняются однократно, при сохранении организации: опечатка
в реквизитах должна обнаруживаться при вводе, а не после отправки платежа.

На горячем пути генерации QR-кода эти функции не вызываются.
"""
...
Таблицы неизменяемы и вынесены на уровень модуля, чтобы не пересобираться
при каждом вызове.
"""
