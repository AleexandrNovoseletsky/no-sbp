...
Revision ID: 966bc90d519d
Revises:
Create Date: 2026-09-01 13:35:07.264956
"""
...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        "ledger_entries",
        ["account_id", "entry_type", "created_at"],
        unique=False,
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index("ix_ledger_entries_account_type_created", table_name="ledger_entries")
