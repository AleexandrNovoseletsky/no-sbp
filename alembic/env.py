...
DSN берётся из настроек приложения, а не из alembic.ini: пароль базы
должен жить в одном месте — в переменных окружения.
"""
...
# миграций решит, что нужно удалить все таблицы.
from nosbp.db import models  # noqa: F401
